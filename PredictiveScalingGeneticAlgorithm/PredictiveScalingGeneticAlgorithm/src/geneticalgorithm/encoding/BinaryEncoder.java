...
/**
 *
 *  BINARYENCODER - Allows real value measurements to be encoded to Binary
 *                  through GUI.java
 * 
 * @author thomasborel
 */
public class BinaryEncoder 
{
    ...
    public BinaryEncoder(int requestsPerSecond, int hourOfDay, int exceptionCounter,
    ...
    public BinaryEncoder(int requestsPerSecond, int hourOfDay, int cpu) 
    {
        this.requestsPerSecond = Integer.toBinaryString(requestsPerSecond);
        this.hourOfDay = Integer.toBinaryString(hourOfDay);
        this.cpu = Integer.toBinaryString(cpu);
    ...
    {       
        ...
        {
            case "Add":
                return stringToReturn.toString() + "10";
                
            case "Delete":
                return stringToReturn.toString() + "01";
                
            case "Modify":
                return stringToReturn.toString() + "11";
                
            case "Nothing":
                return stringToReturn.toString() + "00";
